...
#define STRING_CONFIG_H_AUTHOR "(codetak, Ender-3 Pro)" // Who made the changes.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96.72 }
 ...
 * Probing procedure:
 * 1. Auto Home
 * 2. Move Z axis towards bed till you have some drag on the paper
 * 3. Change offset and save to EEPROM
 * 4. Bed Level and save to EEPROM
 * 5. Repeat if needed till have some drag on Moved Z Axis to Absolute 0.0
 */
...
#define Z_PROBE_LOW_POINT          -2 // Farthest distance below the trigger-point to go before stopping - This is the maximum deviation to go from z_home_pos found
